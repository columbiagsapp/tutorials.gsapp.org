...
<?php endif; ?>
  ...
  <div class="content">
    ...
    <?php
     ...
     echo '<pre>TUTORIAL SAMPLE APP:<br/><br/>';

     echo '<div id="backbone-example-app"></div>';
     echo '<div id="backbone-example-node-container"></div>';
...
<script type="text/javascript" src="/sites/all/themes/framework/js/tutorial_app.js"></script>
