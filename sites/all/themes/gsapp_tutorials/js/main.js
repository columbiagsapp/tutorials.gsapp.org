require.config({
  baseUrl: 'http://tutorials-test7.postfog.org/sites/all/themes/gsapp_tutorials/js',
  ...
  shim: {
    ...
    'drupalbackbone': {
      deps: ['jquery-min', 'underscore-min', 'backbone-min'],
      exports: 'Drupal'
    },
    'drupalbackbone-restws':{
      deps: ['drupalbackbone']
    },
    'app': {
      deps: ['jquery-min', 'underscore-min', 'backbone-min']
...
function(App, $, _, Backbone, Drupal) {
  console.log('running app.js');
  //var Drupal = {};
  //  Drupal.Backbone = DrupalBackbone;
