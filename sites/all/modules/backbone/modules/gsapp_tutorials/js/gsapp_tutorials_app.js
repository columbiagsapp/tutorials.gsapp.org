  ...
  Drupal.behaviors.backbone_example = {
    ...
    attach: function() {
      ...
      var NodeView = Drupal.Backbone.View.extend({
        ...
        templateSelector: '#gsapp-tutorials-node-template',
      ...
      var AppView = Drupal.Backbone.View.extend({
        ...
        templateSelector: '#gsapp-tutorials-app-template',
        ...
        initialize: function() {
          ...
          $('#gsapp-tutorials-app').append(this.render().el);
          this.$('#gsapp-tutorials-node-container').append(this.nodeView.render().el);
        },
