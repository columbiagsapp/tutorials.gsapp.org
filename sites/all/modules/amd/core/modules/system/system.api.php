 ...
 * sub-array is the machine readable name of the library and must be unique.
 * Each library may contain the following items:
 *
 * - 'type': The type of the library; if not 'amd', the scripts will need a shim
 *   configuration to replace the 'define' call.
 * - 'variable': The name of the variable returned by this library. Example: '$'
 *   for jQuery.
